# Mars Rover
This kata follows the same approach described in [the Codurance Katas collection](https://www.codurance.com/es/katas/mars-rover).
## Description
...
__If a rover reaches the end of the plateau, it wraps around the end of the grid.__
